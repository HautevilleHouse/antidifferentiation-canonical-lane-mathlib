...
import HautevilleHouse.AntidifferentiationCanonicalLaneLean.AntidifferentiationObjects
...
theorem theorem_specific_endgame_pilot_checked :
    (forall A : AdmissibleClass, ConstrainedAntidifferentiationClosure A) := by
  intro A
